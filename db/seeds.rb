...
question1 = session1.questions.create!(name: "What is a variable?", category: "MC")
question2 = session1.questions.create!(name: "How to they work?", category: "MC")
question3 = session1.questions.create!(name: "Why does a duck go \"Quack!\"?", category: "MC")
